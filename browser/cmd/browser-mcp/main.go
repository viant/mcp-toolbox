...
type Options struct {
	...
	MatchChromeDriver   bool   `long:"match-chrome-driver" default:"true" description:"Best-effort detect installed Chrome/Chromium major version and download/update matching Chrome-for-Testing chromedriver"`
