...
func (b *binary) xValue(state data.Map) (interface{}, bool, error) { return b.x.Value(state) }
func (b *binary) yValue(state data.Map) (interface{}, bool, error) { return b.y.Value(state) }
...
func (b *binary) lessThan(state data.Map) (interface{}, bool, error) {
	...
	return toolbox.AsFloat(x) < toolbox.AsFloat(y), true, nil
}
...
func (b *binary) notContains(state data.Map) (interface{}, bool, error) {
	...
	return !strings.Contains(toolbox.AsString(x), toolbox.AsString(y)), true, nil
}
...
func (b *binary) and(state data.Map) (interface{}, bool, error) {
	...
	return xBool && toolbox.AsBoolean(y), true, nil
}
...
func (b *binary) or(state data.Map) (interface{}, bool, error) {
	...
	return toolbox.AsBoolean(x) || toolbox.AsBoolean(y), true, nil
}
